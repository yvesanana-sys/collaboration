...
def dashboard():
    """Serve the live trading dashboard HTML file."""
    import os
    ...
    # Fallback — redirect to GitHub raw if file not found locally
    return Response(
        "<html><body style='background:#0a0c0f;color:#e8eaf0;font-family:monospace;padding:40px'>"
        "<h2>Dashboard not found</h2>"
        "<p>Upload dashboard.html to your GitHub repo and redeploy Railway.</p>"
        "<p><a href='/status' style='color:#2dd4bf'>/status</a> &nbsp; "
        "<a href='/performance' style='color:#2dd4bf'>/performance</a></p>"
        "</body></html>",
        mimetype="text/html",
        status=200
    )
