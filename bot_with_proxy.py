...
def repair_status_endpoint():
    ...
    try:
        ...
        # Add debug info to show what env vars the bot actually sees
        status["debug"] = {
            "GITHUB_TOKEN_set":  bool(sr.GITHUB_TOKEN),
            "GITHUB_TOKEN_len":  len(sr.GITHUB_TOKEN),
            "GITHUB_REPO":       sr.GITHUB_REPO or "NOT SET",
            "ANTHROPIC_KEY_set": bool(sr.ANTHROPIC_KEY),
        }
