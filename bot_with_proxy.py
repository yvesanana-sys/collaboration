...
# Sleep manager needs log, shared_state, get_cash_thresholds, get_spy_trend
...
# NOTE: smart_sell and record_trade defined later — see late injection below
...
# ── Late injection: PDT manager (needs smart_sell + record_trade) ──
