...
shared_state = {
    ...
    "proj_total_count":     0,       # Total projections made
    "proj_hit_count":       0,       # Total accurate projections
    "proj_accuracy_pct":    0.0,     # Rolling accuracy percentage
    "last_projections":     {},      # {symbol: {proj_high, proj_low, ...}}
}

# ── Helper logging function (stub)
def log(msg):
