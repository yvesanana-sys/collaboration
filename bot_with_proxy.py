            ...
            if crypto_trader.is_enabled():
                ...
                if shared_state["ai_sleeping"]:
                    ...
                    if should_run_full:
                        ...
                        if is_wkend and (is_first_run or is_hourly_tick):
                            log("🪙 Crypto: weekend — exit monitor only (no AI calls)")
