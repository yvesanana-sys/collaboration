...
BEHAVIORAL_CHECKS = [
    {
        ...
        "max_allowed": 12,       # Max wakes per hour. Crypto trades 24/7, so wake events
                                 # can spike around volatility. 12/hour = roughly 1 every 5 min,
                                 # which matches the cycle cadence. Above this is genuine churn.
        "unit":        "wakes/hour",
    },
    {
        "key":         "ai_brief",
        ...
        "priority":    "high",
        "window_mins": 60,
        "max_allowed": 14,       # Briefs are written when AIs go to sleep — happens
                                 # roughly once per wake cycle. Threshold matches wake threshold + 2 buffer.
        "unit":        "briefs/hour",
    },
    {
        ...
        "priority":    "high",
        "window_mins": 60,
        "max_allowed": 15,       # By DESIGN: cycles run every 5 min during market hours = 12/hour.
                                 # Plus some crypto-side cycles can interleave. 15/hour gives buffer
                                 # for the genuinely intended cadence. Above 15 = real issue.
        "unit":        "cycles/hour",
    },
    {
