...
| Ghost positions (sold outside bot) spam exit-monitor every cycle | Fixed April 25 — pre-check at top of `run_exit_monitor`; `DUST_BALANCE` ($<$1.50) treated as ghost, tracker cleared silently | `binance_crypto.py` |
